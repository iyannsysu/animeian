...
import { CalendarDays, Home, LibraryBig, Search } from "lucide-react";
...
export default function BottomNav() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-40 border-t border-ink-800/60 bg-ink-950/90 backdrop-blur sm:hidden"
